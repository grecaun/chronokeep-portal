...
pub const MOTOROLA_VENDOR_ID: u32 = 161;
//      -- MOTOROLA (Zebra) Message Subtypes
pub const MOTO_GET_TAG_EVENT_REPORT: u16 = 2;
pub const MOTO_PURGE_TAGS: u16 = 3;
pub const MOTO_PURGE_TAGS_RESPONSE: u16 = 4;
pub const MOTO_TAG_EVENT_NOTIFY: u16 = 5;
pub const MOTO_UPDATE_RADIO_FIRMWARE: u16 = 10;
pub const MOTO_UPDATE_RADIO_FIRMWARE_RESPONSE: u16 = 11;
pub const MOTO_UPDATE_RADIO_CONFIG: u16 = 12;
pub const MOTO_UPDATE_RADIO_CONFIG_RESPONSE: u16 = 13;
pub const MOTO_GET_RADIO_UPDATE_STATUS: u16 = 14;
pub const MOTO_GET_RADIO_UPDATE_STATUS_RESPONSE: u16 = 15;
...
pub fn get_llrp_custom_message_name(vendor: u32, kind: u16) -> &'static str {
    match (vendor, kind) {
        (MOTOROLA_VENDOR_ID, MOTO_GET_TAG_EVENT_REPORT) => "CUSTOM MOTOROLA - MOTO_GET_TAG_EVENT_REPORT",
        (MOTOROLA_VENDOR_ID, MOTO_PURGE_TAGS) => "CUSTOM MOTOROLA - MOTO_PURGE_TAGS",
        (MOTOROLA_VENDOR_ID, MOTO_PURGE_TAGS_RESPONSE) => "CUSTOM MOTOROLA - MOTO_PURGE_TAGS_RESPONSE",
        (MOTOROLA_VENDOR_ID, MOTO_TAG_EVENT_NOTIFY) => "CUSTOM MOTOROLA - MOTO_TAG_EVENT_NOTIFY",
        (MOTOROLA_VENDOR_ID, MOTO_UPDATE_RADIO_FIRMWARE) => "CUSTOM MOTOROLA - MOTO_UPDATE_RADIO_FIRMWARE",
        (MOTOROLA_VENDOR_ID, MOTO_UPDATE_RADIO_FIRMWARE_RESPONSE) => "CUSTOM MOTOROLA - MOTO_UPDATE_RADIO_FIRMWARE_RESPONSE",
        (MOTOROLA_VENDOR_ID, MOTO_UPDATE_RADIO_CONFIG) => "CUSTOM MOTOROLA - MOTO_UPDATE_RADIO_CONFIG",
        (MOTOROLA_VENDOR_ID, MOTO_UPDATE_RADIO_CONFIG_RESPONSE) => "CUSTOM MOTOROLA - MOTO_UPDATE_RADIO_CONFIG_RESPONSE",
        (MOTOROLA_VENDOR_ID, MOTO_GET_RADIO_UPDATE_STATUS) => "CUSTOM MOTOROLA - MOTO_GET_RADIO_UPDATE_STATUS",
        (MOTOROLA_VENDOR_ID, MOTO_GET_RADIO_UPDATE_STATUS_RESPONSE) => "CUSTOM MOTOROLA - MOTO_GET_RADIO_UPDATE_STATUS_RESPONSE",
        (_, _) => "UNKNOWN CUSTOM MESSAGE",
    }
}